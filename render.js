wahlomat = function () {
    ...
    if (SPD > 0) {
        ...
        if (Prz == 100) {
            Aussage.innerHTML = "<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Wow. Sicher, dass Du nicht mitgeschrieben hast am Wahlprogramm? Deine Posititionen entsprechen zu 100% denen der SPD in Herne. </h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a><a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>";
        } else if (Prz >= 80) {
            Aussage.innerHTML = `<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Sehr schön, Deine Positionen entsprechen zu ${Prz}% denen der SPD in Herne.</h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu' > Kontaktiere uns. </button> <a>`;
        } else if (Prz >= 60) {
            Aussage.innerHTML = `<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Das sieht doch schon ganz passend aus. Deine Positionen enstprechen zu ${Prz}% denen der SPD in Herne. Schau Dir doch mal unser Wahlprogramm an, vielleicht können wir Dich ja noch mit einigen weiteren Punkten überzeugen. </h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>`;
        } else if (Prz >= 40) {
            Aussage.innerHTML = `<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Da müssen wir wohl noch einige Überzeugungsarbeit bei Dir leisten. Deine Positionen entsprechen zu ${Prz}% denen der SPD in Herne. Schreib uns doch, was wir in Deinen Augen besser machen könnten. </h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>`;
        } else if (Prz > 0) {
            Aussage.innerHTML = `<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Deine Positionen entsprechen zu ${Prz}% denen der SPD in Herne. Wir sind uns sicher: Da geht noch mehr. Schreib uns und lass uns diskutieren, was wir in Deinen Augen besser machen könnten. </h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>`;
        } else {
            Aussage.innerHTML = "<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Bist Du Dir sicher, dass Du hier richtig bist? Deine Positionen entsprechen zu 0% denen der SPD in Herne.</h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>"
        }
    } else {
        Aussage.innerHTML = "<div class='header'><p id='p1'> SPD Herne Wahl-O-Mat</p><p id='p2'> Sov viel SPD steckt in dir...</p><img src='logo.png' style='display: block; width: 100%; grid-row-start: 1; grid-row-end: 3;'/></div><div id='weiss'><h3> Dich interessiert keine der Aussagen? Schreib uns doch einmal, was Dich interessieren würde.</h3></div><a href=#target2><button class='neu' onclick='hide()'>Noch einmal.</button></a> <a href=mailto: amelie.menges@gmx.de> <button class='neu'> Kontaktiere uns. </button> <a>"
    }
